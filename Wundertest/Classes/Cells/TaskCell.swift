...
class TaskCell: UITableViewCell {
    ...
    override func updateConstraints() {
        if (!self.hasLoadedConstraints) {
            ...
            self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[button]|", options: .directionMask, metrics: metrics, views: views))

            self.contentView.addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[title]|", options: .directionMask, metrics: nil, views: views))
